...
export default function PanelButton({ openPanel, setOpenPanel, index, name, classN }: PanelButtonProps) {
    return(
        <button
          ...
          className={`${classN} font-bangers text-white text-shadow-[3px_3px_0px_#000] text-shadow-black cursor-pointer text-[25px] flex items-center justify-center lg:justify-start lg:flex-col flex-shrink-0 lg:py-6 gap-3 duration-500
