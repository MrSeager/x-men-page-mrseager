...
export default function CharacterPanel({ openPanel, classN, fromFade, toFade, classP, order, data }: CharacterPanelProps) {
    return(
        <div
            className={`
        ...
        >
            ...
            <div className={`absolute bottom-0 left-0 right-0 h-10 bg-gradient-to-b from-transparent ${toFade} z-20`} />
        </div>
    );
}